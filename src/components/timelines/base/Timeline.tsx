...
export class Timeline<T> extends React.Component<{ data: ParseDataResult, eventBus: EventBusClass, dataCallback?: (d) => void, config: T, groupWidth?:number}, { overlayContent: any | null }> {
